...
namespace SPE_website.Migrations
{
    ...
    [Migration("20260910152930_AddApplicationUserCardNumber")]
    partial class AddApplicationUserCardNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPE_website.Data.Models.Member", b =>
                {
                    b.Property<string>("CardNumber")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime>("LastSeenImport")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("SPE_website.Features.Events.Models.Event", b =>
                {
                    ...
                    b.Property<Guid?>("PublicRegistrationToken")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPE_website.Features.Tasks.Models.TaskItem", b =>
                {
                    b.HasOne("SPE_website.Data.Models.ApplicationUser", "AssignedBy")
                        .WithMany()
